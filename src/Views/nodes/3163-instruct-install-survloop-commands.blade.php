<!-- resources/views/vendor/survlooporg/nodes/3163-instruct-install-survloop-commands.blade.php -->

<h4 class="slBlueDark">Install LEMP Stack</h4>
<p>
...
<h4 class="slBlueDark">Setup Server's Domain</h4>
<p>
...
<h4>Create Swap File (optional)</h4>
<p>
...
<pre># echo "Y" | apt-get install php-pear pkg-config php-xml php7.4-xml php7.4-cli php-dev
...
<h3>Install SSL Certificate (Recommended)</h3>
<p>
...
<h3>Initialize Survloop Installation</h3>
<p>
    Then browsing to the home page should prompt you to
    create the first admin user account:<br />
    <a href="http://survloop.local" target="_blank">http://survloop.local</a>
</p>
<p>
    If everything looks janky, then
    manually load the style sheets, etc:<br />
    <a href="http://survloop.local/css-reload" target="_blank"
        >http://survloop.local/css-reload</a>
</p>
<p>
    After logging in as an admin, this link
    rebuilds many supporting files:<br />
    <a href="http://survloop.local/dashboard/settings?refresh=2"
        target="_blank"
        >http://survloop.local/dashboard/settings?refresh=2</a>
</p>
<p><br /></p>

<h3>Install Advanced Intrusion Detection Environment (Optional)</h3>
<p>
